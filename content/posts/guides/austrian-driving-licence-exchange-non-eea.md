---
title: 'Converting My Indian Driving Licence to an Austrian One (Non-EEA Exchange)'
date: 2026-08-20T09:00:00+02:00
draft: false
author: 'Puneeth Prakash'
description: 'A phase-by-phase account of exchanging a non-EEA driving licence for an Austrian one: the medical exam, the BH appointment, document verification, and driving school.'
...
menu:
  sidebar:
    name: 'Austrian Driving Licence Exchange'
    identifier: 'guide-driving-licence-exchange'
    parent: 'guides'
    weight: 482
---
...
## Phase 1: Booking the Medical Certificate Appointment
...
## Phase 2: The Medical Exam

This is where the appointment stops feeling routine. The medical check for a driving licence is more thorough than I expected, and it's not just an eye test.

**Paperwork first.** I was handed a sheet listing various medical conditions and had to mark whether I had any of them.

**Vitals.** A staff member checked my height, weight, blood pressure, and pulse before I saw the doctor.

**The consultation.** The doctor asked if I understood everything on the sheet I'd filled in, confirmed I didn't have any of the listed conditions, and asked if I was taking any medications.

**The eye test.** She had me stand about 10 feet from the eye chart. I didn't need to read the top row since it's large enough to be obvious anyway. I read every row after that, and the very last row wasn't necessary either. If you can read it, great, but it's not required.

**Balance and coordination.** This part surprised me the most:

- Stand straight, close your eyes, hold both arms out in front of you for 5 to 10 seconds. She's checking for shaking hands or loss of balance.
- With your eyes still closed, touch the tip of your index finger to the tip of your nose.
- Touch your toes standing up, without bending your knees.
- Do a single squat.
- Rotate your ankles and wrists, to check mobility.

**The last question.** She asked if I knew which driving school I'd be going to. I said I wasn't sure yet, so she left that field blank on the certificate rather than naming a specific school.

I paid an invoice of **35 euros** on the way out, and that was the medical phase done.

---

## Phase 3: Booking the BH Appointment for Licence Exchange

With the medical report in hand, the next step is booking the actual appointment at the BH for **Re-registration/Exchange - Non-EEA State**. I booked mine through the [BH-Bregenz appointment reservation system](https://www.bh-termine-reservieren.at/bregenz/).

For this appointment, the listed requirements were:
...
She gave me a sheet to review, confirming all my details, and I had to sign it at both the top and the bottom with the pen she provided. Then she took everything, including my **original Indian driving licence**, and explained the next steps:

- The licence would be sent to the police first.
- From there, it goes to Vienna for verification.
- Once verified, I'd get a call back telling me whether I could go ahead and book the practical test at a driving school.
...
- [BH-Bregenz Appointment Reservation](https://www.bh-termine-reservieren.at/bregenz/)
- [Medical Report Information (oesterreich.gv.at)](https://www.oesterreich.gv.at/de/themen/persoenliche_dokumente_und_bestaetigungen/fuehrerschein/1/1/Seite.040720)
- [Passport Photo Criteria (oesterreich.gv.at)](https://www.oesterreich.gv.at/lexicon/P/Seite.991253.html)
